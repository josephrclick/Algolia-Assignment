    ...
    instantsearch.widgets.hits({
        ...
        <article>
          ...
          <div>
            ...
            <p><b>Released:</b> ${components.Highlight({
                    hit,
                    attribute: "year"
                })}</p>
            <p><b>Starring:</b> ${components.Highlight({
                    hit,
                    attribute: "actors"
                })}</p>
            <p><b>Directed by:</b> ${components.Highlight({
                    hit,
                    attribute: "director"
                })}</p>
            <p><b>Overview:</b> ${components.Highlight({
                    hit,
                    attribute: "overview"
                })}</p>
            <p><b>Genres:</b> ${components.Highlight({
                    hit,
                    attribute: "genres"
                })}</p>
          </div>
